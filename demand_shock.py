...
def lockdown_demand_shock(df, arg):
    ...
    if arg == 0:
        ...
        plt.legend()
        plt.savefig("assets/lockdown_demand_shock.png")
    elif arg == 1:
        ...
        plt.annotate("Trough: -32.3%", xy=(y.idxmin(),y.min()), xytext=(40,20), **params)
        ...
        plt.legend()
        plt.savefig("assets/lockdown_demand_deviation.png")
...
def west_cyclone_demand_shock(df):
    ...
    plt.savefig("assets/west_cyclone_demand_shock.png")
